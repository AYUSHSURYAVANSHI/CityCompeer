      ...
      <footer className="footerContainer footer-footer1">
        <div className="footer-container">
          ...
          <nav className="footer-nav">
            <span className="footer-nav1 bodySmall">{props.Nav1}</span>
            <span className="footer-nav2 bodySmall">{props.Nav2}</span>
            <span className="footer-nav3 bodySmall">{props.Nav3}</span>
            <span className="footer-nav4 bodySmall">{props.Nav4}</span>
            <span className="footer-nav5 bodySmall">{props.Nav5}</span>
          </nav>
        </div>
...
Footer.defaultProps = {
  Logo: 'CityCompeer',
  text: '© 2023 CityCompeer, All Rights Reserved.',
  Nav1: 'Explore',
  Nav2: 'Upload',
  Nav3: 'Buy/Sell/Rent',
  Nav4: 'Blog',
