    ...
    <div className="header-header">
      ...
      >
        ...
        <div data-thq="thq-navbar-nav" className="header-desktop-menu">
          <nav className="header-links m-2">
            <Link className="header-nav1 bodySmall">{props.Nav1}</Link>
            <Link to="/chatbot" className="header-nav2 bodySmall">{props.Nav2}</Link>
            <Link className="header-nav3 bodySmall">{props.Nav3}</Link>
            <Link className="header-nav4 bodySmall">{props.Nav4}</Link>
            <Link className="header-nav5 bodySmall">{props.Nav5}</Link>
          </nav>
        ...
        >
          <div className="header-nav">
            ...
            <nav className="header-links1">
              <span className="header-nav1 bodySmall">{props.Nav1}</span>
              <span className="header-nav21 bodySmall">{props.Nav21}</span>
              <span className="header-nav31 bodySmall">{props.Nav31}</span>
              <span className="header-nav41 bodySmall">{props.Nav41}</span>
              <span className="header-nav51 bodySmall">{props.Nav51}</span>
            </nav>
